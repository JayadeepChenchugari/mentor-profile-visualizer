  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="fixed left-4 top-1/2 transform -translate-y-1/2 z-10 flex flex-col gap-4">
        <div className="bg-white p-3 rounded-full shadow-lg hover:shadow-xl transition-shadow cursor-pointer">
      ...
      {/* Right Sidebar */}
      <div className="fixed right-4 top-1/2 transform -translate-y-1/2 z-10 flex flex-col gap-4">
        <div className="bg-white p-3 rounded-full shadow-lg hover:shadow-xl transition-shadow cursor-pointer">
      ...
      <div className="relative h-64 bg-gradient-to-r from-violet-600 to-purple-700">
        <img 
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {mentor.languages.map((language, index) => (
                      <span key={index} className="border border-gray-800 text-gray-800 px-3 py-1 rounded-full text-sm">
                        {language}
                      </span>
                    ))}
                  </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex gap-1">
                        {[...Array(profile.avatars)].map((_, i) => (
                          <div key={i} className="w-6 h-6 bg-gray-300 rounded-full border-2 border-white -ml-1 first:ml-0"></div>
                        ))}
                      </div>
                      <span className="text-xs text-gray-600">{profile.sessions} Sessions</span>
                    </div>
                  </div>
                ))}
              </div>
